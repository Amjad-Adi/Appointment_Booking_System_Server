import {
    ...
    ORGANIZATION_APPOINTMENT_MANAGEMENT, UPDATE_TIME_BLOCK
} from "./permissions.js";
...
const crmPermissions:string[]=[
    READ_USERS,UPDATE_WORKING_HOURS,ORGANIZATION_APPOINTMENT_MANAGEMENT,UPDATE_TIME_BLOCK
]
...
const managerPermissions:string[]=[
    ...
    READ_USERS,
    CREATE_ROOM,
    UPDATE_ROOM,UPDATE_WORKING_HOURS,ORGANIZATION_APPOINTMENT_MANAGEMENT
]
