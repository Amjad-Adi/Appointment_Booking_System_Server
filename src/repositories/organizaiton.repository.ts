...
import {
    ...
    COLUMN_TIMEZONE as LOCATION_COLUMN_TIMEZONE,
...
export async function findByUuid(
    ...
    const result = await pool.query(
        `SELECT
            ...
            ${LOCATION_ALIAS}.${LOCATION_COLUMN_TIMEZONE},
